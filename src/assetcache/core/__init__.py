...
the folder-watcher debouncer.  Later milestones extend this package
with the analysis pipeline (M2), search/MCP (M3), spritesheet logic
(M4) and Unity Asset Store imports (M5).
"""
